...
<div class="main-container">
    ...
    <div class="center-container">
        <div class="product-details">
            <form action="/cart?action=addToCart&id=${product.productID}" method="post">
                ...
                <p class="product-price">Giá: <fmt:formatNumber value="${product.price}" type="number" pattern="#,###" /> đ</p>
                ...
                <div class="quantity-controls">
                    ...
                    <input type="number" id="quantity" name="quantityBuy" value="1" min="1">
                </div>
    ...
    <div class="right-container">
        ...
        <div class="contact-info">
            ...
            <p>Liên hệ qua Facebook: <a href="https://www.facebook.com/profile.php?id=100047868483999" target="_blank">Facebook</a></p>
        </div>
    </div>
</div>
</body>
